# linak-control — Docker (secure)

> Running inside a Docker container. Repo mounted at /Volumes/Moon/Coding/linak-control.
...
- Working directory: /Volumes/Moon/Coding/linak-control
...
- Push to remote repository at least every 10 commit
