...
- [x] **T2.1 BLEController — CoreBluetooth Wrapper** `[activity: build-feature]`
...
- [x] **T2.2 DPG1C Handshake** `[activity: build-feature]`
...
- [x] **T2.3 DeskManager Actor** `[activity: domain-modeling]`
...
- [x] **T2.4 Movement Control (Up/Down/Stop)** `[activity: build-feature]`
...
- [x] **T2.5 Preset Recall (Go-To)** `[activity: build-feature]`
...
- [x] **T2.6 Preset Save** `[activity: build-feature]`
...
- [x] **T2.7 Reconnection & Wake-Up** `[activity: build-feature]`
...
- [x] **T2.8 Phase Validation** `[activity: validate]`
