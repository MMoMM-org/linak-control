...
- [x] **T6.1 FirstRunView — Welcome & Scanning** `[activity: build-feature]`
...
- [x] **T6.2 FirstRunView — Connect & Complete** `[activity: build-feature]`
...
- [x] **T6.3 SettingsView** `[activity: build-feature]`
...
- [x] **T6.4 Login Item (SMAppService)** `[activity: build-feature]`
...
- [x] **T6.5 Notification Center Integration** `[activity: build-feature]`
...
- [x] **T6.6 Global Hotkeys** `[activity: build-feature]`
