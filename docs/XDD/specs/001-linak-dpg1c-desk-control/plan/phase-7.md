...
- [ ] **T7.1 Integration Test: UI ↔ BLE Flow** `[activity: validate]`
...
- [ ] **T7.3 Reconnection & Error Recovery Test** `[activity: validate]`
...
- [ ] **T7.6 PRD Acceptance Criteria Audit** `[activity: validate]`
...
- [ ] **T7.7 Phase Validation** `[activity: validate]`
