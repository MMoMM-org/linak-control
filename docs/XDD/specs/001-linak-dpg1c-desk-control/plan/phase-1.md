...
- [x] **T1.1 Xcode Project Skeleton** `[activity: build-feature]`
...
- [x] **T1.2 BLE Characteristic Constants** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.3 DeskProtocol — Encoding & Decoding** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.4 Data Models** `[activity: domain-modeling]` `[parallel: true]`
...
- [x] **T1.5 ConfigStore — Settings Persistence** `[activity: domain-modeling]`
...
- [x] **T1.6 HeightConverter & Logger** `[activity: build-feature]` `[parallel: true]`
...
- [x] **T1.7 Phase Validation** `[activity: validate]`
