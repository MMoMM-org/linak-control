...
- [x] **T5.1 Root Command & Argument Parsing** `[activity: build-feature]`
...
- [x] **T5.2 Status Command** `[activity: build-feature]` `[parallel: true]`
...
- [x] **T5.3 Height Command** `[activity: build-feature]` `[parallel: true]`
...
- [x] **T5.4 Move Commands (up/down)** `[activity: build-feature]` `[parallel: true]`
...
- [x] **T5.5 Preset Command** `[activity: build-feature]` `[parallel: true]`
...
- [x] **T5.6 Service Command** `[activity: build-feature]`
...
- [x] **T5.7 Error Formatting** `[activity: build-feature]`
...
- [x] **T5.8 Phase Validation** `[activity: validate]`
