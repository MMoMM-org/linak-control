...
- [x] **T4.1 DeskViewModel** `[activity: build-feature]`
...
- [x] **T4.2 MenuBarController — Two-Zone Setup** `[activity: build-feature]`
...
- [x] **T4.3 PresetDropdownView (Zone 2 Menu)** `[activity: build-feature]` `[parallel: true]`
...
- [x] **T4.4 PopoverView — Main View** `[activity: build-feature]`
...
- [x] **T4.5 MovementControlView (Up/Down Buttons)** `[activity: build-feature]` `[parallel: true]`
...
- [x] **T4.6 PresetGridView (2x2 Grid in Popover)** `[activity: build-feature]` `[parallel: true]`
...
- [x] **T4.7 App Entry Point** `[activity: build-feature]`
...
- [x] **T4.8 Phase Validation** `[activity: validate]`
